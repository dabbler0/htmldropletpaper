...
\item Allow students to view an edit real-world wepages as either blocks or text: \emph{the system must match the real world}.
...
\begin{figure*}
\centering
\includegraphics[width=3in]{dropdown.png}
